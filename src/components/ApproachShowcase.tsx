...
export function ApproachShowcase({ steps }: Props) {
  ...
  return (
    <section id="approach" className="w-full bg-[#00338D] py-20 text-white">
      <div className="relative flex w-full overflow-hidden bg-[#002A6E] shadow-[0_25px_60px_rgba(0,33,105,0.35)] min-h-[520px]">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[rgba(0,33,105,0.85)] via-[rgba(0,51,141,0.55)] to-transparent" />
              ...
              {steps.map((_, index) => (
                <button
                  ...
                  className={`h-2.5 w-12 rounded-full transition ${
                    activeIndex === index ? "bg-[#0091DA]" : "bg-white/40"
                  }`}
                />
              ))}
            </div>
